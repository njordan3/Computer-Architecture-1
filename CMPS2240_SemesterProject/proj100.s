...
menu_prmpt:  .asciiz "Choose an image:\n1 csub3.ppm\n2 csub3_.ppm\n3 p6test.ppm\n4 spock.ppm\n0 exit\n\nEnter image number: "

user_input:  .word 4
             .word 0

file_csub3:  .asciiz "csub3.ppm"
file_csub3_: .asciiz "csub3_.ppm"
file_p6test: .asciiz "p6test.ppm"
file_spock:  .asciiz "spock.ppm"

# error messages in case something runs wrong
errormsg1:   .asciiz "\nImproper command line format. Usage: spim -f prog100.s\n"

input_error_prmpt:  .asciiz "User input must be an option shown by the menu\n"
...
main:
    ...
    beq $s0, 1, menu        # we are okay to attempt to open file if the number of command line arguments is 1 
