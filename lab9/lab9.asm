...
section .rodata
   ...
   num_format db "%ld",0
   sum_prompt db "The sum of %ld and %ld is %ld.",10,0
   equal_prompt db "%ld and %ld are equal.",10,0
...
section .text
   ...
   main:
      ...
      jg     greaterthan    ; jump if num1 > num2
    
      ; num1 = num2
      mov     rdi, dword equal_prompt
      mov     rsi, [rbp-8]  ; num1
      mov     rdx, [rbp-16] ; num2
      call    printf
      jmp sum               ; jump to find the sum
